...
All notable changes to AgentaOS will be documented in this file.
...
- **MCP server**: Give Claude, Cursor, or any AI assistant access to AgentaOS signing — send ETH, send tokens, check balances, x402 payments.
